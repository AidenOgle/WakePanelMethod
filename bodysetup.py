...
def body_creation(bodytype, num_panels, chord, customx, customy, NACA, quarterchord, eccentricity, trailingedge, bodyshape):
    ...
    bodyshape:      'closed' or 'open' bodyshape. Used in Kutta condition enforcement. Required for 'custom' bodyshape, automatically assigned for others
    """
    try:
        match bodytype:
            case 'line':
...
def pitching(pitchingtype, num_step, a1, a2, rate, amplitude, period, phase):
